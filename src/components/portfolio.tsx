...
const customPortfolioData: LocalPortfolioProps = {
  ...
  socialLinks: [
    ...
    { icon: <img src={websiteIcon} alt="Website" className="w-4 h-4 grayscale hover:grayscale-0 transition-all duration-300 dark:invert" />, href: 'https://bsky.app/profile/engineeringpm.bsky.social' },
  ...
  workExperience: [
    {
      ...
      icon: <div className="w-10 h-10 bg-blue-900 rounded-full flex items-center justify-center text-white text-lg">🚀</div>
    },
    {
      ...
      icon: <div className="w-10 h-10 bg-amber-600 rounded-full flex items-center justify-center text-white text-lg">📊</div>
    },
    {
      company: 'Priceline',
      position: 'Product Engineer',
      ...
      icon: <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white text-lg">📱</div>
    }
  ],
  projects: [
    {
  ...
  companies: [
    { name: 'Gap', logo: <img src="logos/gap.png" alt="Gap Inc." className="h-12 w-auto grayscale hover:grayscale-0 transition-all duration-300 object-contain" /> },
    { name: 'JPMorgan', logo: <img src="logos/jpmorgan.jpg" alt="JPMorgan Chase" className="h-12 w-auto grayscale hover:grayscale-0 transition-all duration-300 object-contain" /> },
    { name: 'Priceline', logo: <img src="logos/priceline.jpg" alt="Priceline" className="h-12 w-auto grayscale hover:grayscale-0 transition-all duration-300 object-contain" /> },
    { name: 'TD', logo: <img src="logos/td.jpg" alt="TD Bank" className="h-12 w-auto grayscale hover:grayscale-0 transition-all duration-300 object-contain" /> },
    { name: 'Ryerson', logo: <img src="logos/ryerson.jpg" alt="Ryerson University" className="h-12 w-auto grayscale hover:grayscale-0 transition-all duration-300 object-contain" /> }
  ],
